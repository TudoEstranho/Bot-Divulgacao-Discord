...
not_dmed  = []
content = """
**Mehor loja do momento, temos: nitro, bots, selfs, bot pra div, seguidores, entre outros**
**Entre e confira os melhores preços do discord e todas as compras são automaticas**
